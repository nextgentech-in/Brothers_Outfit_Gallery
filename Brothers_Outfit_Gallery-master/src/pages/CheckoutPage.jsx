...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = async (e) => {
    ...
    // Fallback: Even if Delhivery API check fails or indicates not serviceable,
    // we allow standard shipping checkout so it never blocks genuine orders.
    // We removed the strict blockade based on delhiveryStatus.serviceable.
